...
(() => {
 ...
 for(const root of document.querySelectorAll('#cuda-streams-lab,#autograd-lab,#dispatch-lab,#matrix-lab,#fw-lab,#pt-route,#pt-multiply,#tensor-layout,.memory-demo,#band-lab,#symmetric-lab,#cuda-map,#lab-lif,[data-wave-lab]')){
